...
export const routes: Routes = [
    ...
    { path: 'leaves', canActivate: [authGuard], loadChildren: () => import('./features/leaves/leaves.routes').then(m => m.LEAVE_ROUTES) },
    ...
    { path: 'loans', canActivate: [authGuard], loadChildren: () => import('./features/loans/loan.routes').then(m => m.LOAN_ROUTES) },
];
